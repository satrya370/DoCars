...
class PackageController extends Controller
{
    ...
    public function index()
    {
        ...
        JsonLdMulti::setTitle("Bali Tresna Travel | Travel Bali | Tour & Travel Bali");
    ...
    public function show(Package $package)
    {
        ...
        JsonLdMulti::setTitle("$package->name |Bali Tresna Travel");
