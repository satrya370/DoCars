          ...
          <table class="w-full">
            ...
            <tbody>
              ...
              <tr class="border-b boder-gray-900">
                <td class="text-sm text-black font-medium px-6 py-4 btext-blackspace-nowrap">
                  {{ $loop->iteration }}
                </td>
                <td class="text-sm text-black font-medium px-6 py-4 btext-blackspace-nowrap">
                  {{ $package->name }} 
                  <span class="inline-block py-1.5 px-2.5 leading-none text-center btext-blackspace-nowrap align-baseline text-sm bg-emerald-600 text-white rounded-lg">{{ $package->category->name }}</span>
                </td>
                <td class="text-sm text-black font-light py-4 flex gap-x-3">
